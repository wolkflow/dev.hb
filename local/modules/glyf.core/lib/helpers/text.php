...
{	
	 ...
	 * @return string
	 */
	public static function i18nday($index, $short = false)
	{
        if (!$short) {
            $days = array(
                0  => Loc::getMessage('DAY_SUNDAY'),
                1  => Loc::getMessage('DAY_MONDAY'),
                2  => Loc::getMessage('DAY_TUESDAY'),
                3  => Loc::getMessage('DAY_WEDNESDAY'),
                4  => Loc::getMessage('DAY_THURSDAY'),
                5  => Loc::getMessage('DAY_FRIDAY'),
                6  => Loc::getMessage('DAY_SATURDAY'),
                7  => Loc::getMessage('DAY_SUNDAY'),
            );
        } else {
            $days = array(
